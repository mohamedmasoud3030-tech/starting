...
export function ProcurementWorkspace({
  ...
  return (
    <main className="space-y-5" aria-labelledby="procurement-title">
      <header><h1 id="procurement-title" className="text-lg font-black sm:text-xl">الموردون والمشتريات</h1><p className="mt-0.5 text-sm text-slate-600">إدارة الموردين وطلبات التوريد والاستلام من مكان واحد.</p></header>
