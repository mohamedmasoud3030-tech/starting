...
describe("buildHomeVoiceSummary", () => {
  it("produces the owner summary: today, ready count, one staff shortage", () => {
    ...
    expect(summary).toBe(
      "عندك اليوم ٣ مناسبات. مناسبتان جاهزتان. مناسبة قاعة النخيل اليوم الساعة ٧ مساءً ناقصها شخصان من الفريق. لا توجد مشاكل أخرى تحتاج تدخل الآن.",
    );
  });
  ...
  it("reports an equipment shortage", () => {
    ...
    expect(summary).toBe(
      "عندك اليوم مناسبة واحدة. مناسبة قاعة النخيل اليوم الساعة ٧ مساءً ناقصها ٣ من المعدات. لا توجد مشاكل أخرى تحتاج تدخل الآن.",
    );
  });
...
describe("buildEventsListVoiceSummary", () => {
  ...
  it("summarizes total, status highlights and the next event", () => {
    expect(
      ...
      "عندك ٥ مناسبات. منها مناسبتان مؤكدتان و مناسبة واحدة قيد التجهيز و مناسبة واحدة ملغاة. المناسبة القادمة زفاف قاعة النخيل غداً الساعة ٦ مساءً.",
    );
  });
...
describe("buildEventVoiceSummary", () => {
  ...
  it("covers number, time, customer, venue, guests, status and readiness", () => {
    expect(
      ...
      "مناسبة رقم ١٢٥ اليوم الساعة ٧ مساءً. العميل محمد. الموقع قاعة النخيل. عدد الضيوف ١٢٠. المناسبة مؤكدة. المناسبة جاهزة.",
    );
  });
  ...
  it("reports a staff shortage", () => {
    expect(
      ...
      "مناسبة رقم ١٢٥ اليوم الساعة ٧ مساءً. العميل محمد. الموقع قاعة النخيل. عدد الضيوف ١٢٠. المناسبة مؤكدة. الفريق ناقص شخصين.",
    );
  });
  ...
  it("reports an equipment shortage", () => {
    expect(
      ...
      "مناسبة رقم ١٢٥ اليوم الساعة ٧ مساءً. العميل محمد. الموقع قاعة النخيل. عدد الضيوف ١٢٠. المناسبة مؤكدة. المعدات ناقصة ٣.",
    );
  });
  ...
  it("reports multiple issues in one short sentence", () => {
    expect(
      ...
      "مناسبة رقم ١٢٥ اليوم الساعة ٧ مساءً. العميل محمد. الموقع قاعة النخيل. عدد الضيوف ١٢٠. المناسبة مؤكدة. الفريق ناقص شخص واحد والمعدات ناقصة ٢.",
    );
  });
  ...
  it("never narrates stale readiness for a cancelled event", () => {
    expect(
      ...
      "مناسبة رقم ١٢٥ اليوم الساعة ٧ مساءً. العميل محمد. الموقع قاعة النخيل. عدد الضيوف ١٢٠. المناسبة ملغاة.",
    );
  });
});
