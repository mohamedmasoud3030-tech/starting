...
select throws_ok($$select public.record_staff_attendance('97000000-0000-0000-0000-0000000000a1','97000000-0000-0000-0000-0000000000e1','97000000-0000-0000-0000-0000000000a6','97000000-0000-0000-0000-0000000000d1','2026-10-01','MORNING','2026-10-01 14:00+04','2026-10-01 19:00+04',0,'PRESENT','PER_HOUR',10.000,'duplicate slot','97200000-0000-0000-0000-000000000002')$$,'23505','ATTENDANCE_SLOT_ALREADY_RECORDED','different key cannot duplicate the same live attendance slot');
select throws_ok($$select public.record_staff_attendance('97000000-0000-0000-0000-0000000000a1','97000000-0000-0000-0000-0000000000e1','97000000-0000-0000-0000-0000000000a7','97000000-0000-0000-0000-0000000000d1','2026-10-02','MORNING','2026-10-02 14:00+04','2026-10-02 19:00+04',0,'PRESENT','PER_HOUR',10.000,'wrong assignment','97200000-0000-0000-0000-000000000003')$$,'23503','ASSIGNMENT_MISMATCH','assignment must match the same event and staff member');
...
select lives_ok($$select public.record_staff_attendance('97000000-0000-0000-0000-0000000000a1','97000000-0000-0000-0000-0000000000e1','97000000-0000-0000-0000-0000000000a6',null,'2026-10-01','MORNING','2026-10-01 14:00+04','2026-10-01 19:00+04',0,'PRESENT','PER_HOUR',10.000,'corrected','97200000-0000-0000-0000-000000000005')$$,'void releases the business slot for a corrected repost');
