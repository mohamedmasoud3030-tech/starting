...
select lives_ok($$select public.create_event('10000000-0000-0000-0000-0000000000a1','10000000-0000-0000-0000-0000000000c1','Overlapping','X','2026-09-01 13:00+04','2026-09-01 18:00+04',10,'M',null,null,null,null,null,'11000000-0000-0000-0000-000000000004')$$,'second Event created');
...
select throws_ok($$update public.quotation_lines set description='tamper'$$,'P0001','QUOTATION_IMMUTABLE','issued quote lines immutable');
...
select lives_ok($$select public.create_event('10000000-0000-0000-0000-0000000000a1','10000000-0000-0000-0000-0000000000c1','Adjacent','X','2026-09-01 14:00+04','2026-09-01 18:00+04',10,'M',null,null,null,null,null,'11000000-0000-0000-0000-000000000005')$$,'adjacent Event created');
