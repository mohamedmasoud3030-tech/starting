...
select lives_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1','96000000-0000-0000-0000-0000000000d1','2026-10-01','MORNING','2026-10-01 14:00+04','2026-10-01 19:30+04',0,'PRESENT','first shift','96200000-0000-0000-0000-0000000000a1')$$,'OWNER records PER_HOUR attendance');
...
select lives_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1','96000000-0000-0000-0000-0000000000d1','2026-10-01','MORNING','2026-10-01 14:00+04','2026-10-01 19:30+04',0,'PRESENT','first shift','96200000-0000-0000-0000-0000000000a1')$$,'same key replays');
...
select throws_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1','96000000-0000-0000-0000-0000000000d1','2026-10-01','MORNING','2026-10-01 14:00+04','2026-10-01 19:30+04',0,'PRESENT','edited notes','96200000-0000-0000-0000-0000000000a1')$$,'22023','IDEMPOTENCY_KEY_PAYLOAD_MISMATCH','same key, different payload hard-rejects');

-- ABSENT has no times and zero earned.
select lives_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1',null,'2026-10-01','EVENING',null,null,0,'ABSENT','no show',gen_random_uuid())$$,'OWNER records ABSENT');
...
select throws_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1',null,'2026-10-01','EVENING','2026-10-01 14:00+04',null,0,'ABSENT','bad',gen_random_uuid())$$,'P0001','ABSENT_HAS_NO_TIMES','ABSENT with times is rejected');

-- Cross-org event reference is rejected.
select throws_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e2','96000000-0000-0000-0000-0000000000f1',null,'2026-10-01','MORNING',null,null,0,'ABSENT','x',gen_random_uuid())$$,'P0002','EVENT_NOT_FOUND','cross-org event reference is rejected');
...
select throws_ok($$select public.record_staff_attendance('96000000-0000-0000-0000-0000000000a1','96000000-0000-0000-0000-0000000000e1','96000000-0000-0000-0000-0000000000f1','96000000-0000-0000-0000-0000000000d1','2026-10-02','MORNING','2026-10-02 14:00+04','2026-10-02 20:00+04',0,'PRESENT','acc',gen_random_uuid())$$,'42501','NOT_AUTHORIZED','ACCOUNTANT cannot record attendance');
