-- ============================================================================
-- 0047 — S9 attendance validation ordering
--
-- Semantic request validation must run before business-slot conflict checks.
-- Otherwise an invalid request against an already-used slot can be reported as
-- ATTENDANCE_SLOT_ALREADY_RECORDED instead of the real payload error. This keeps
-- idempotent replay first, preserves assignment authority and live-slot locking,
-- and makes command errors deterministic for operators and tests.
-- ============================================================================
